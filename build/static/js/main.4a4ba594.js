/*! For license information please see main.4a4ba594.js.LICENSE.txt */
(() => {
  'use strict';
  var e = {
      730: (e, n, t) => {
          ...
          function s(e, n, t, r) {
            ...
            return a === x
              ...
              : null !== n &&
                ...
                : (((r = Ms(t.type, t.key, t.props, null, e.mode, r)).ref = va(
                    e,
                    n,
                    t,
                  )),
          ...
          function d(e, n, t) {
            ...
            if ('object' === typeof n && null !== n) {
              switch (n.$$typeof) {
                case w:
                  return (
                    ((t = Ms(n.type, n.key, n.props, null, e.mode, t)).ref = va(
                      e,
                      null,
                      n,
                    )),
        ...
        function wo(e) {
          ...
          if (null !== (e = t.interleaved)) {
            l = e;
            do {
              (o = l.lane), (oo.lanes |= o), (Ii |= o), (l = l.next);
            } while (l !== e);
        ...
        function Ho(e, n, t) {
          return 0 === (21 & ao)
            ? (e.baseState && ((e.baseState = !1), (bu = !0)),
              (e.memoizedState = t))
            : (ur(t, n) ||
                ((t = vn()), (oo.lanes |= t), (Ii |= t), (e.baseState = !0)),
              n);
        }
        function Wo(e, n) {
          var t = kn;
        ...
        var Zo = {
          ...
          Jo = {
            ...
            useImperativeHandle: function (e, n, t) {
              return (
                (t = null !== t && void 0 !== t ? t.concat([e]) : null),
                Fo(4194308, 4, Uo.bind(null, n, e), t)
              );
            },
        ...
        function iu(e, n, t, r) {
          var l = e.stateNode;
          (l.props = t), (l.state = e.memoizedState), (l.refs = {}), Ia(e);
          var a = n.contextType;
          'object' === typeof a && null !== a
            ? (l.context = Ta(a))
            ...
            return (function (e, n, t, r, l, o, u) {
              ...
              if ('$!' === l.data) {
                if ((r = l.nextSibling && l.nextSibling.dataset))
                  var i = r.dgst;
                return (
                  (r = i), Uu(e, n, u, (r = cu((o = Error(a(419))), r, void 0)))
                );
              }
        ...
        function qu(e, n, t) {
          ...
          switch ((na(n), n.tag)) {
            ...
            case 19:
              if ((Cl(Ja), null === (o = n.memoizedState))) return Qu(n), null;
        ...
        function vs(e, n) {
          ...
          if ((_a(), (Pi = t), (Ci.current = r), null !== Ti))
            throw Error(a(261));
  ...
  var r = t(43),
    ...
    a = t(579);
  const o = (e) => {
      let { filters: n, selected: t, onSelectFilter: r } = e;
      return (0, a.jsx)('div', {
        className: 'toolbar',
        children: n.map((e) =>
          (0, a.jsx)(
    ...
    u = (e) => {
      ...
      return (0, a.jsx)('div', {
        ...
        children: n.map((e, n) =>
          (0, a.jsx)('img', { src: e.img, alt: e.category }, n),
        ),
      });
    },
    i = [];
  class s extends r.Component {
    constructor(e) {
      super(e),
        (this.onSelectFilter = (e) => {
          this.setState({ selected: e });
        }),
        (this.filterProjects = () => {
          const { selected: e } = this.state;
          return 'All' === e ? i : i.filter((n) => n.category === e);
        }),
    ...
    render() {
      return (0, a.jsxs)('div', {
        ...
        children: [
          ...
          (0, a.jsx)(u, { projects: this.filterProjects() }),
        ],
      });
    }
  }
  const c = s,
    ...
    d = (e) => {
      ...
      return (0, a.jsxs)('div', {
        className: 'shop-card',
        children: [
          (0, a.jsx)('img', { src: n.img, alt: n.name }),
          (0, a.jsxs)('div', {
            className: 'details',
            children: [
              (0, a.jsx)('h2', { children: n.name }),
              (0, a.jsx)('p', { children: n.color }),
              (0, a.jsxs)('p', { children: ['$', n.price] }),
            ],
          }),
        ],
      });
    ...
    p = (e) => {
      ...
      return (0, a.jsx)('div', {
        ...
        children: n.map((e, n) => (0, a.jsx)(d, { product: e }, n)),
      });
    },
    m = (e) => {
      let { product: n } = e;
    ...
    h = (e) => {
      ...
      return (0, a.jsx)('div', {
        className: 'list-view',
        children: n.map((e, n) => (0, a.jsx)(m, { product: e }, n)),
      });
    },
    v = [];
    ...
    constructor(e) {
      super(e),
        (this.onSwitch = () => {
          this.setState((e) => {
            let { view: n } = e;
            return { view: 'module' === n ? 'list' : 'module' };
          });
        }),
        (this.state = { view: 'module' });
    }
    render() {
      const { view: e } = this.state;
      return (0, a.jsxs)('div', {
        className: 'store',
        children: [
          (0, a.jsx)(f, {
            icon: 'module' === e ? 'view_list' : 'view_module',
  ...
  const y = g,
    b = (e) => {
      let { item: n, onClick: t, isSelected: r } = e;
      return (0, a.jsx)('div', {
        className: 'dropdown-item '.concat(r ? 'selected' : ''),
        onClick: () => t(n),
        children: n.name,
      });
    },
    k = (e) => {
      let { items: n, selectedItem: t, onItemClick: r } = e;
      return (0, a.jsx)('div', {
        className: 'dropdown-list',
        children: n.map((e) =>
          (0, a.jsx)(b, { item: e, isSelected: e === t, onClick: r }, e),
        ),
      });
    },
    w = () => {
  ...
  const S = function () {
    return (0, a.jsxs)('div', {
      className: 'App',
      children: [
        (0, a.jsx)('h1', { children: 'My React Projects' }),
        (0, a.jsx)(c, {}),
        (0, a.jsx)(y, {}),
        (0, a.jsx)(w, {}),
      ],
  ...
  l.createRoot(document.getElementById('root')).render((0, a.jsx)(S, {}));
})();
//# sourceMappingURL=main.4a4ba594.js.map
